...
public enum GuiText {
	...
	SELECTOR_POSITION_NEAR("selector.position.near"),
	SELECTOR_POSITION_FAR("selector.position.far"),
	SELECTOR_YAW_ALIGN("selector.yaw_alignment"),
	...
	TRACK_POSITION_NEAR("track.position.near"),
	TRACK_POSITION_FAR("track.position.far"),
