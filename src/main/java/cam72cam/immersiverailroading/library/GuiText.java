...
public enum GuiText {
	...
	TRACK_ROLL_EFFECT_TILE_TRUE("track.roll_effect_tile_true"),
	TRACK_ROLL_EFFECT_TILE_FALSE("track.roll_effect_tile_false"),
	...
	TRACK_EXTRA_TRACKGUI("track.extra_trackgui"),
	TRACK_EXTRAGUI("track.extragui"),
