...
public enum GuiText {
	...
	TRACK_LABEL_LENGTH("track.label_length"),
	TRACK_LABEL_NO_LENGTH("track.label_no_length"),
	TRACK_LABEL_RADIUS("track.label_radius"),
	TRACK_LABEL_LENGTH_RADIUS("track.label_length_radius"),
	TRACK_LABEL_NEAR_RADIUS("track.label_near_radius"),
	TRACK_LABEL_FAR_RADIUS("track.label_far_radius"),
	TRACK_SWAP_RADIUS("track.swap_radius"),
