...
public class Bell extends PartSound {
    ...
    public static Bell get(ComponentProvider provider, ModelState state, SoundDefinition soundFile) {
    ...
    public Bell(ModelComponent component, SoundDefinition soundFile) {
