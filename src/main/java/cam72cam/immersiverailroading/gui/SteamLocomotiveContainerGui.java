...
public class SteamLocomotiveContainerGui extends ContainerGuiBase {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
    	...
    	drawTankBlock(i + paddingLeft, currY - inventoryRows * slotSize, horizSlots*2, inventoryRows, stock.getLiquid().internal, stock.getLiquidAmount() / (float)stock.getTankCapacity().MilliBuckets());
